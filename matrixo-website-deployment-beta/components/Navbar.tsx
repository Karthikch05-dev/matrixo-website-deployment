                ...
                <AnimatePresence>
                  {showFeaturesDropdown && (
                    <motion.div
                      ...
                      className="absolute top-full right-0 mt-2 w-80 overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-xl"
                    >
                      {betaLinks.map((link, index) => (
                        <Link
                          ...
                          className="block px-6 py-4 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors border-b border-gray-200 dark:border-gray-700 last:border-b-0"
                        >
