      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-800 rounded-lg shadow-xl w-[calc(100%-2rem)] max-w-md max-h-[90vh] flex flex-col z-50 overflow-hidden"
          >
            {/* Header - Fixed */}
