...
export default function FeatureToggleButton({ isOpen, onClick }: FeatureToggleButtonProps) {
  return (
    <button
      ...
      onClick={onClick}
      className="fixed left-4 z-[45] w-12 h-28 rounded-full border border-white/40 dark:border-white/10 bg-gradient-to-b from-white/85 via-white/70 to-white/60 dark:from-gray-900/85 dark:via-gray-900/70 dark:to-gray-950/80 backdrop-blur-xl shadow-lg shadow-black/10 dark:shadow-black/40 text-gray-900 dark:text-white transition-all duration-300 hover:scale-105 hover:shadow-[0_0_20px_rgba(59,130,246,0.35)] dark:hover:shadow-[0_0_20px_rgba(129,140,248,0.45)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/60 flex items-center justify-center"
