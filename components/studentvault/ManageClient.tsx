...
export default function ManageClient() {
  ...
  if (!user) {
    return (
      <div className="rounded-2xl border border-white/10 bg-white/5 p-8 text-center max-w-lg mx-auto">
        <FaLock className="mx-auto mb-3 text-2xl text-gray-400" aria-hidden="true" />
        <h2 className="font-semibold text-white mb-2">Sign in required</h2>
  ...
  if (!isEmployee) {
    return (
      <div className="rounded-2xl border border-red-500/20 bg-red-500/10 p-8 text-center max-w-lg mx-auto">
        ...
        <h2 className="font-semibold text-red-300 mb-1">Not authorized</h2>
        ...
        <Link
          href="/studentvault"
          className="inline-flex rounded-xl bg-white/10 px-4 py-2 text-sm font-semibold text-white hover:bg-white/20"
        >
